      ...
      {options.map((option) => {
        ...
        return (
          <button
            ...
            className={`rounded-2xl border p-4 text-left transition-all disabled:cursor-not-allowed disabled:opacity-60 ${selected
          ...
          >
            <div
              className={`mb-3 flex size-9 items-center justify-center rounded-xl ${selected
          ...
          <div className="w-full max-w-3xl">
            ...
            <div className="rounded-2xl border bg-card p-2 shadow-md shadow-foreground/5 transition-shadow focus-within:shadow-lg">
              <Textarea
                ...
                className="min-h-28 resize-none border-0 bg-transparent px-4 py-3 text-base shadow-none focus-visible:ring-0 mb-2"
                aria-label={
                  intentMode === "request"
